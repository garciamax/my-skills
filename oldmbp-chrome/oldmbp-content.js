...
if (!url) {
	console.log("Usage: oldmbp-content.js <url>");
	console.log("\nExtracts readable content from a URL as markdown.");
	console.log("\nExamples:");
	console.log("  oldmbp-content.js https://example.com");
	console.log("  oldmbp-content.js https://en.wikipedia.org/wiki/Rust_(programming_language)");
	process.exit(1);
}
